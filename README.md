<h1 align ="center">:relaxed: Atividade-AWS-DOCKER :writing_hand: :relaxed:</h1><br>
...
## :white_check_mark: Requisitos da atividade:
   ...
   :small_green_diamond: Instalação e configuração do DOCKER ou CONTAINERD no host EC2.
